...
template YearRegex(msg_bytes) {
	...
	// substrings calculated: [{(15, 16), (16, 17), (17, 18), (18, 19)}]
	signal prev_states0[4][msg_bytes];
	signal is_substr0[msg_bytes];
	signal is_reveal0[msg_bytes];
	signal output reveal0[msg_bytes];
	for (var i = 0; i < msg_bytes; i++) {
		 // the 0-th substring transitions: [(15, 16), (16, 17), (17, 18), (18, 19)]
		...
		is_substr0[i] <== MultiOR(4)([prev_states0[0][i] * states[i+2][16], prev_states0[1][i] * states[i+2][17], prev_states0[2][i] * states[i+2][18], prev_states0[3][i] * states[i+2][19]]);
