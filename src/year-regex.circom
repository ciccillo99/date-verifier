...
template YearRegex(msg_bytes) {
	...
	// substrings calculated: [{(18, 19), (19, 20), (20, 21), (21, 22)}]
	signal prev_states0[4][msg_bytes];
	signal is_substr0[msg_bytes];
	signal is_reveal0[msg_bytes];
	signal output reveal0[msg_bytes];
	for (var i = 0; i < msg_bytes; i++) {
		 // the 0-th substring transitions: [(18, 19), (19, 20), (20, 21), (21, 22)]
		...
		is_substr0[i] <== MultiOR(4)([prev_states0[0][i] * states[i+2][19], prev_states0[1][i] * states[i+2][20], prev_states0[2][i] * states[i+2][21], prev_states0[3][i] * states[i+2][22]]);
